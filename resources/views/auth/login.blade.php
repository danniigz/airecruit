<x-guest-layout title="Iniciar sesión">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <p class="mt-4 text-sm text-slate-600">
            ...
            <a class="underline text-brand-600 hover:text-brand-700 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500" href="{{ route('register') }}">
                {{ __('Regístrate') }}
            </a>
        </p>
    </form>
