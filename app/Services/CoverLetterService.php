...
class CoverLetterService
{
    ...
    private function systemPrompt(): string
    {
        return <<<PROMPT
            ...
            que mejor encajen con la oferta. La carta debe tener una extensión de
            entre 200 y 350 palabras, con saludo y despedida incluidos. Responde
            ÚNICAMENTE con el texto de la carta, sin explicaciones adicionales, sin
            comillas envolventes y sin formato markdown.
            PROMPT;
    }
}
